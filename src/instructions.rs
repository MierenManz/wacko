...
//         // if byte == 0xFD {
//         //     let other_byte = match self {
//         //         Instruction::V128Load(_) => 0x00,
//         //         Instruction::V128Load8x8S(_) => 0x01,
//         //         Instruction::V128Load8x8U(_) => 0x02,
//         //         Instruction::V128Load16x4S(_) => 0x03,
//         //         Instruction::V128Load16x4U(_) => 0x04,
//         //         Instruction::V128Load32x2S(_) => 0x05,
//         //         Instruction::V128Load32x2U(_) => 0x06,
//         //         Instruction::V128Load8Splat(_) => 0x07,
//         //         Instruction::V128Load16Splat(_) => 0x08,
//         //         Instruction::V128Load32Splat(_) => 0x09,
//         //         Instruction::V128Load64Splat(_) => 0x0a,
//         //         Instruction::V128Store(_) => 0x0b,
//         //         Instruction::V128Const(_) => 0x0c,
//         //         Instruction::I8x16Shuffle(_) => 0x0d,
//         //         Instruction::I8x16Swizzle => 0x0e,
//         //         Instruction::I8x16Splat => 0x0f,
//         //         Instruction::I16x8Splat => 0x10,
//         //         Instruction::I32x4Splat => 0x11,
//         //         Instruction::I64x2Splat => 0x12,
//         //         Instruction::F32x4Splat => 0x13,
//         //         Instruction::F64x2Splat => 0x14,
//         //         Instruction::I8x16ExtractLaneS(_) => 0x15,
//         //         Instruction::I8x16ExtractLaneU(_) => 0x16,
//         //         Instruction::I8x16ReplaceLane(_) => 0x17,
//         //         Instruction::I16x8ExtractLaneS(_) => 0x18,
//         //         Instruction::I16x8ExtractLaneU(_) => 0x19,
//         //         Instruction::I16x8ReplaceLane(_) => 0x1a,
//         //         Instruction::I32x4ExtractLane(_) => 0x1b,
//         //         Instruction::I32x4ReplaceLane(_) => 0x1c,
//         //         Instruction::I64x2ExtractLane(_) => 0x1d,
//         //         Instruction::I64x2ReplaceLane(_) => 0x1e,
//         //         Instruction::F32x4ExtractLane(_) => 0x1f,
//         //         Instruction::F32x4ReplaceLane(_) => 0x20,
//         //         Instruction::F64x2ExtractLane(_) => 0x21,
//         //         Instruction::F64x2ReplaceLane(_) => 0x22,
//         //         Instruction::I8x16Eq(_) => 0x23,
//         //         Instruction::I8x16Ne(_) => 0x24,
//         //         Instruction::I8x16LtS(_) => 0x25,
//         //         Instruction::I8x16LtU(_) => 0x26,
//         //         Instruction::I8x16GtS(_) => 0x27,
//         //         Instruction::I8x16GtU(_) => 0x28,
//         //         Instruction::I8x16LeS(_) => 0x29,
//         //         Instruction::I8x16LeU(_) => 0x2a,
//         //         Instruction::I8x16GeS(_) => 0x2b,
//         //         Instruction::I8x16GeU(_) => 0x2c,
//         //         Instruction::I16x8Eq(_) => 0x2d,
//         //         Instruction::I16x8Ne(_) => 0x2e,
//         //         Instruction::I16x8LtS(_) => 0x2f,
//         //         Instruction::I16x8LtU(_) => 0x30,
//         //         Instruction::I16x8GtS(_) => 0x31,
//         //         Instruction::I16x8GtU(_) => 0x32,
//         //         Instruction::I16x8LeS(_) => 0x33,
//         //         Instruction::I16x8LeU(_) => 0x34,
//         //         Instruction::I16x8GeS(_) => 0x35,
//         //         Instruction::I16x8GeU(_) => 0x36,
//         //         Instruction::I32x4Eq(_) => 0x37,
//         //         Instruction::I32x4Ne(_) => 0x38,
//         //         Instruction::I32x4LtS(_) => 0x39,
//         //         Instruction::I32x4LtU(_) => 0x3a,
//         //         Instruction::I32x4GtS(_) => 0x3b,
//         //         Instruction::I32x4GtU(_) => 0x3c,
//         //         Instruction::I32x4LeS(_) => 0x3d,
//         //         Instruction::I32x4LeU(_) => 0x3e,
//         //         Instruction::I32x4GeS(_) => 0x3f,
//         //         Instruction::I32x4GeU(_) => 0x40,
//         //         Instruction::F32x4Eq(_) => 0x41,
//         //         Instruction::F32x4Ne(_) => 0x42,
//         //         Instruction::F32x4Lt(_) => 0x43,
//         //         Instruction::F32x4Gt(_) => 0x44,
//         //         Instruction::F32x4Le(_) => 0x45,
//         //         Instruction::F32x4Ge(_) => 0x46,
//         //         Instruction::F64x2Eq(_) => 0x47,
//         //         Instruction::F64x2Ne(_) => 0x48,
//         //         Instruction::F64x2Lt(_) => 0x49,
//         //         Instruction::F64x2Gt(_) => 0x4a,
//         //         Instruction::F64x2Le(_) => 0x4b,
//         //         Instruction::F64x2Ge(_) => 0x4c,
//         //         Instruction::V128Not(_) => 0x4d,
//         //         Instruction::V128And(_) => 0x4e,
//         //         Instruction::V128AndNot(_) => 0x4f,
//         //         Instruction::V128Or(_) => 0x50,
//         //         Instruction::V128Xor(_) => 0x51,
//         //         Instruction::V128Bitselect(_) => 0x52,
//         //         Instruction::V128AnyTrue(_) => 0x53,
//         //         Instruction::V128Load8Lane(_) => 0x54,
//         //         Instruction::V128Load16Lane(_) => 0x55,
//         //         Instruction::V128Load32Lane(_) => 0x56,
//         //         Instruction::V128Load64Lane(_) => 0x57,
//         //         Instruction::V128Load8Lane(_) => 0x58,
//         //         Instruction::V128Load16Lane(_) => 0x59,
//         //         Instruction::V128Load32Lane(_) => 0x5a,
//         //         Instruction::V128Load64Lane(_) => 0x5b,
//         //         Instruction::V128Load32Zero(_) => 0x5c,
//         //         Instruction::V128Load64Zero(_) => 0x5d,
//         //         Instruction::F32x4DemoteF64x2Zero(_) => 0x5e,
//         //         Instruction::F64x2PromoteLowF32x4(_) => 0x5f,
//             // };
//         // }
